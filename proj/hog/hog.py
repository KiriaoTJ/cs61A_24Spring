...
def boar_brawl(player_score, opponent_score):
    ...
    return 1 if a == b else 3 * abs(a - b)
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        d : int = strategy0(score0, score1) if who == 0 else strategy1(score1, score0)
        if who == 0:
            score0 = update(d, score0, score1, dice)
        else:
            score1 = update(d, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def make_averaged(original_function, samples_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def ans_function(*args):
        s : int = 0
        for _ in range(samples_count):
            s += original_function(*args)
        return s / samples_count
    return ans_function
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for i in range(1, 10 + 1):
        ...
        print('DEBUG:','ans=',ans,'score_max=',score_max)
        if score > score_max:
            score_max = score
            ans = i
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    #return num_rolls  # Remove this line once implemented.
    return 0 if sus_points(score + boar_brawl(score, opponent_score)) - score >= threshold else num_rolls
    # END PROBLEM 11
